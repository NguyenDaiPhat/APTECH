...
using _28_3_2023.Models;

namespace _28_3_2023.Controllers
{
    public class GenresController : Controller
    {
        private readonly MoviesStoreContext _context;

        public GenresController(MoviesStoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Genres != null ? 
                          ...
                          Problem("Entity set 'MoviesStoreContext.Genres'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MoviesStoreContext.Genres'  is null.");
            }
            var genre = await _context.Genres.FindAsync(id);
            if (genre != null)
            {
